...
type Field = keyof Pick<Medication, 'originalText' | 'productName' | 'strength' | 'form' | 'activeSubstance' | 'atcCode' | 'dosageText' | 'certificateDosageText' | 'quantity' | 'totalActiveSubstance' | 'treatmentDays' | 'notes'>;
...
const fields: [Field, string, keyof Medication['confidence'] | null][] = [
  ...
  ['dosageText', 'Fullständig doseringsanvisning', 'dosage'], ['certificateDosageText', 'Dosering på intyget (högst 88 tecken)', null], ['quantity', 'Mängd (internt)', 'quantity'],
