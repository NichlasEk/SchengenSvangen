...
- Kund- och förskrivarbilder körs genom lokal OCR i RAM. Förskrivarens för- och efternamn, arbetsplatsadress och telefon föreslås från fältetiketter och positioner när säkerheten är tillräcklig. Om direkttelefon saknas används den tydligt märkta arbetsplatstelefonen som kontakttelefon, med synlig källmarkering i granskningen. Två separata klipp kan kombineras med **Använd** för namnklippet och **Fyll tomma fält** för arbetsplatsklippet; det sker bara efter aktivt val av granskaren. Fel eller ofullständiga klipp kan ge tomma fält.
...
- För en okänd produkt kan farmaceuten ange ett separat **manuellt klassningsbeslut** (intyg/inget intyg), aktuell FASS- eller LV-länk, motivering, signum och en aktiv bekräftelse av exakt preparat, styrka, form och substans. Beslutet märks `manual-review`; det ändrar inte referensmotorns svar och ogiltigförklaras om produktidentiteten ändras. Systemet kontrollerar att länken har rätt domän men kan inte själv verifiera sidans innehåll. Farmaceuten måste kontrollera källan och uppgifterna. PDF:en är fortfarande ett demo-utkast.
